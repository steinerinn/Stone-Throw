...
export function mountGroupResult(){
 ...
 return {render(s,animating){
  ...
  setResultArt(document.getElementById('resultArt'),outcome);document.getElementById('resultSubtitle').replaceChildren(...scoreLines(s.matchScore).map(text=>el('div','cs-match-score',text)));
