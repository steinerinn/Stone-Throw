...
export interface HostReplay {contract:'stone-throw-private-replay-v1';rulesVersion:HostState['config']['rulesVersion'];initial:HostState;initialFingerprint:string;steps:ReplayStep[];finalFingerprint:string}
