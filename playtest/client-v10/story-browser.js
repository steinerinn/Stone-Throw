...
export async function mountStoryBrowser(transport,{replaceConfiguration}){
 ...
 const callbacks={playback,externalSession:true,inputLocked:()=>busy||tutorials.open(),blocked:()=>busy||paused||tutorials.open(),configuration:()=>active,
