import {playtestStateDirectory} from './playtest.mjs';
...
export async function startPlaytest({stateDir=playtestStateDirectory(false)+'-dev',open=openBrowser}={}){
 const options={playtestSnapshotOnly:true,development:true,lan:false,bind:'127.0.0.1',stateDir,publicOrigin:undefined,secureCookies:false};
