...
export function playtestStateDirectory(lan=false){
 ...
 return path.resolve(root,'..','playtest-state-multiplayer-stabilization-'+(lan?'lan':'local'),'build-'+build);
}
export async function startPlaytest({lan=false,stateDir=playtestStateDirectory(lan),open=openBrowser}={}){
 const options={development:false,lan,bind:lan?'0.0.0.0':'127.0.0.1',stateDir,publicOrigin:undefined,secureCookies:false};
