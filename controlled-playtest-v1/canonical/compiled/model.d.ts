...
export declare function id<K extends string>(value: string): Id<K>;
...
export interface Unit {
    ...
    type: UnitType | null;
    cells: Cell[];
    lifecycle: 'unplaced' | 'present' | 'destroyed' | 'unresolved';
    damage: {
        cells: Cell[];
...
export interface PendingEffect {
    ...
    status: 'queued' | 'active' | 'unresolved';
}
...
export interface PendingDecision {
    ...
    unitChoices: UnitId[];
    remaining: number | null;
    candidateCoverage: 'complete' | 'unavailable';
}
export interface PlagueState {
    ownerId: PlayerId | null;
    targetId: PlayerId;
    boardId: BoardId;
    moveOnPlayerId: PlayerId | null;
    origin: Cell | null;
    outbreaks: {
        ordinal: number;
        round: number;
...
export interface HistoricalEvent {
    id: EventId;
    kind: 'impact' | 'damage-restored' | 'relocation' | 'unit-observed';
    actorId: PlayerId | null;
    targetId: PlayerId;
    boardId: BoardId;
    unitId: UnitId | null;
...
export interface KnownContact {
    ...
    unitType: UnitType | null;
    cells: Cell[];
    completeGeometry: boolean;
}
export interface Clue {
    kind: 'monk-candidates' | 'resurrection-search' | 'hero-search' | 'elf-scout';
    cells: Cell[];
}
...
export interface ObserverKnowledge {
    boards: Record<string, BoardKnowledge>;
    events: VisibleEvent[];
    stats: VisibleStat[];
...
export interface MatchState {
    ...
    plagues: PlagueState[];
    resurrections: ResurrectionState[];
...
export interface ObserverSnapshot {
    ...
    boards: Board[];
    ownedUnits: Unit[];
    knowledge: Record<string, BoardKnowledge>;
    events: VisibleEvent[];
    stats: VisibleStat[];
    decisions: VisibleDecision[];
    turn: ObserverKnowledge['turn'];
    outcome: Outcome | null;
}
