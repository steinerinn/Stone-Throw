...
const events = arr(obj({ sequence: num, kind: en('impact', 'miss', 'unit-disclosed', 'resurrection-announced', 'hero-moved', 'plague-observed'), boardId: str, cell: nullable(cell), unitType: nullable(unitType), contactId: nullable(str) }));
