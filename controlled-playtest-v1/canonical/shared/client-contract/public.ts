...
export interface PublicEvent {position:number;kind:'impact'|'miss'|'unit-disclosed'|'resurrection-announced'|'hero-moved'|'plague-observed';side:Side;cell:Cell|null;unitKind:UnitKind|null}
...
export interface PresentationFrame {snapshot:Snapshot;events:PublicEvent[]}
